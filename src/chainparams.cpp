...
public:
    CMainParams()
    {
        ...
        nLastPOWBlock = 250;
        nCATScoinBadBlockTime = 1471401614; // Skip nBit validation of Block 259201 per PR #915
        nCATScoinBadBlocknBits = 0x1c056dac; // Skip nBit validation of Block 259201 per PR #915
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "We love cats";
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zcats to be stakable
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nLastPOWBlock = 200;
        nCATScoinBadBlockTime = 1489001494; // Skip nBit validation of Block 259201 per PR #915
        nCATScoinBadBlocknBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        nMaturity = 15;
        nStakeMinDepth = 100;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet catscoin addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet catscoin script addresses start with '8' or '9'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 73);     // starting with 'W'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet catscoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet catscoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet catscoin BIP44 coin type is '1' (All coin's testnet default)
        ...
        strSporkPubKeyOld = "04b010f0de7ddfc82731db44c151212d6e37cf463dda899c274080094cb6e097ed87d589dba422827028176c12ca96f4e7c21c8d9381d71c3fcac1fdef5e5d4456";
        strObfuscationPoolDummyAddress = "catsfGRkekRyDRNeJiLtYVEbvhXrNbmox";
